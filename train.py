...
parser.add_argument('--var_weight', default=None, type=float)
...
def train_zsl(model, train_loader, val_loader, val_unseen_loader, wordvec_array, args, unseen_ids=None, seen_ids=None):
    ...
    criterion = SDLLoss(wordvec_array=seen_wordvec, weight=args.var_weight)  # regularization weight can be zero for coco
