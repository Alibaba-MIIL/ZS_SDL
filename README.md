...
- [wordvec_array.pickle](data/COCO/cls_ids.pickle) and [cls_ids.pickle](data/COCO/wordvec_array.pickle) include coco word-vectors and seen-uneen class ids respectively, and should be located in the metadata path.
